...
#
CBXEXPORT
void carbon::filesystem::create_directory(type::cstring8_t s_path) throw (io::IOException) {
...
CBXEXPORT
void carbon::filesystem::enum_directory_contents(path& s_directory_path, directory_contents_enumerator f_enumerator) throw (io::IOException) {
...
CBXEXPORT
std::vector<carbon::filesystem::path> carbon::filesystem::get_directory_contents(path& s_directory_path) throw (io::IOException) {
#pragma region <locals>
...
CBXEXPORT
void carbon::filesystem::remove_directory(type::cstring8_t s_path) throw (io::IOException) {
