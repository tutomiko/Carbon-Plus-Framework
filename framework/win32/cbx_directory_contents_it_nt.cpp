...
#
#
carbon::sys::directory_contents_iterator::directory_contents_iterator(type::cstring8_t s_directory_path) throw (io::IOException) {
...
carbon::sys::directory_contents_iterator::~directory_contents_iterator(void) {
#pragma region <locals>
...
void carbon::sys::directory_contents_iterator::close(void) throw (io::IOException) {
#pragma region <locals>
	HANDLE h_find;
#pragma endregion
...
bool carbon::sys::directory_contents_iterator::has_next(void) {
#pragma region <locals>
	BOOL              b_find = FALSE;
	WIN32_FIND_DATAA* o_find_data;
#pragma endregion
...
carbon::sys::path carbon::sys::directory_contents_iterator::next(void) {
#pragma region <locals>
	WIN32_FIND_DATAA* o_find_data;
	path              s_path;
#pragma endregion
