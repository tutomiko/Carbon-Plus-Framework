...
#
CBXEXPORT
void carbon::filesystem::delete_file(type::cstring8_t s_file_path) throw (io::IOException) {
...
CBXEXPORT
unsigned int carbon::filesystem::get_file_size(type::cstring8_t s_file_path) throw (io::IOException) {
...
CBXEXPORT
unsigned long long carbon::filesystem::get_file_size_big(type::cstring8_t s_file_path) throw (io::IOException) {
#pragma region <locals>
	HANDLE        FileHandle = INVALID_HANDLE_VALUE;
...
CBXEXPORT
void carbon::filesystem::zero_file(type::cstring8_t s_file_path) throw (io::IOException) {
#pragma region <locals>
	HANDLE        FileHandle = INVALID_HANDLE_VALUE;
	LARGE_INTEGER FileSize;
