...
#
#
void carbon::sys::path::subpath_iterator::first(void) {
	this->cursor = 0;
}


bool carbon::sys::path::subpath_iterator::has_next(void) {
	for (;; this->cursor++) {
		char c;
...
carbon::sys::path carbon::sys::path::subpath_iterator::next(void) {
