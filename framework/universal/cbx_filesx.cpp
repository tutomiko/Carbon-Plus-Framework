...
#
#
void carbon::sys::delete_file(path& s_file_path) throw (io::IOException) {
	return delete_file(s_file_path.c_str());
}


void carbon::sys::destroy_file(type::cstring8_t s_file_path) throw (io::IOException) {
...
void carbon::sys::destroy_file(path& s_file_path) throw (io::IOException) {
	zero_file(s_file_path);
...
void carbon::sys::zero_file(path& s_file_path) throw (io::IOException) {
